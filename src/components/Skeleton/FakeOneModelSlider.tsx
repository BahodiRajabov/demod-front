...
const FakeSimpleSlider = ({ name }: any) => {
    ...
    function SliderRightHandler() {
        if(sliderCount < fakeModelImages.length - 1){
    ...
    const ListStyle = {
        ...
        padding:"0 !important",
        display:"flex",
        width:`${fakeModelImages?.length * (name === "slider" ? 507 : 720)}px`,  
...
export default FakeSimpleSlider